<template>
  <table-layout>
      ...
      <el-table-column label="操作" align="center">
        <template #default="{ row }">
          ...
          <el-tooltip content="权限" placement="top">
            <el-button type="primary" size="large" @click="showPowerDialog(row)" link>
    ...
    <el-dialog append-to-body v-model="powerVisible" top="30vh" draggable width="450px">
      <template #title>
        <div class="flex content-center">
          <el-text>核算主体</el-text>
          <el-icon><ArrowRight /></el-icon>
...
import { Delete, Edit, Search, Plus, Minus, ArrowRight, User } from '@element-plus/icons-vue';
...
const showPowerDialog = async (row: any) => {
  powerVisible.value = true;
  powerForm.value = cloneDeep(row);
  await nextTick();
};
</script>
