  ...
  <table-layout>
    <template #header>
      <div class="flex">
        ...
        <el-form-item label="是否生效"></el-form-item>
    ...
    <el-table v-loading="tableLoading" :data="tableData" class="custom-table" height="100%">
      ...
      <el-table-column label="核算标准" align="center"></el-table-column>
      <el-table-column label="数据源" align="center"></el-table-column>
      <el-table-column label="核算年份" align="center"></el-table-column>
      <el-table-column label="是否生效" align="center"></el-table-column>
      <el-table-column label="合并方法" align="center"></el-table-column>
      <el-table-column label="碳配额" align="center"></el-table-column>
    ...
    <el-dialog append-to-body v-model="dialogVisible" top="30vh" draggable width="450px">
      ...
      >
        <el-form-item label="核算主体">
          <el-select placeholder="" clearable filterable @change=""></el-select>
        </el-form-item>
        <el-form-item label="核算标准">
          <el-select placeholder="" clearable filterable @change=""></el-select>
        </el-form-item>
