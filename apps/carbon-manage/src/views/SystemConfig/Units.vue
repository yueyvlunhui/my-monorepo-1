<template>
  <table-layout>
    ...
    <el-table v-loading="tableLoading" :data="tableData" class="custom-table" height="100%">
      ...
      <el-table-column prop="unit" label="基准单位" align="center"></el-table-column>
      <el-table-column label="换算系数" align="center"></el-table-column>
    ...
    <el-dialog append-to-body v-model="dialogVisible" top="30vh" draggable width="450px">
      ...
      >
        ...
        <el-form-item label="换算系数">
          <el-input v-model.trim="form.en" placeholder="请输入换算系数" class="w-full" clearable />
        </el-form-item>
      </el-form>
      <template #footer>
        <div>
